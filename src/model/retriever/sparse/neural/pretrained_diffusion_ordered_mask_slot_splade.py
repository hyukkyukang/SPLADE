...
class PretrainedDiffusionOrderedMaskSlotSpladeModel(OrderedMaskSlotSpladeModel):
    """Ordered mask-slot sparse retriever initialized from a diffusion backbone."""
    ...
    def _validate_tokenizer_matches_model(
        ...
        if tokenizer_vocab_size != model_vocab_size:
            raise ValueError(
                "PretrainedDiffusionOrderedMaskSlotSpladeModel requires tokenizer and "
                "model vocabulary sizes to match. "
    ...
    def _validate_tokenizer_matches_baseline(
        ...
        *,
        ...
        if tokenizer_vocab != baseline_vocab:
            raise ValueError(
                "Primary diffusion-backbone ordered-mask-slot ablations require the "
                "same tokenizer vocabulary as the baseline. "
                f"tokenizer_source={self.tokenizer_source!r}, "
